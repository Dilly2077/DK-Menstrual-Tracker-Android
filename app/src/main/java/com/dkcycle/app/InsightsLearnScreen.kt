    ...
    val topics = remember {
        listOf(
            LearnTopic(
                ...
                note = "Averelle estimates timing from period history. It cannot confirm ovulation from dates alone."
            ),
            LearnTopic(
                title = "Menstrual phase",
                shortTitle = "Menstrual",
                art = LearnArt.MENSTRUAL,
            ...
            LearnTopic(
                ...
                note = "Averelle does not confirm ovulation. Its fertile and ovulation dates are estimates only."
            ),
            LearnTopic(
                title = "Luteal phase",
                shortTitle = "Luteal",
                ...
                note = "A late period can have many causes. Averelle cannot diagnose why a cycle changes."
            )
        )
    }
...
private fun LearnPhaseCard(topic: LearnTopic) {
    Card(
        ...
        Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
            LearnIllustration(topic.art, topic.title)
            Column(
